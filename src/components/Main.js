          ...
          <main role="main" className="col-lg-12 ml-auto mr-auto" style={{ maxWidth: '1024px' }}>
            <div className="content">
              ...
              <div className="card mb-3 mx-auto" style={{ maxWidth: '512px' }}>
                <h2 className="text-primary"><b>StorageFi</b></h2>
                  <p className="text-white"><b>Share A File</b></p>
                  <form onSubmit={(event) => {
                    ...
                    <button type="submit" className="btn-primary btn"><b>Upload</b></button>
                  </form>
              </div>
              <p>&nbsp;</p>
              <table className="table-sm table-bordered " style={{ width: '1000px', maxHeight: '450px'}}>
                ...
                { this.props.files.map((file, key) => {
                  return(
                    <thead style={{ 'fontSize': '14px', 'fontWeight': 'bold' }} key={key}>
                      <tr>
                        <td>{file.fileId}</td>
                        <td>{file.fileName}</td>
